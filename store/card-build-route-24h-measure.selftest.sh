...
echo
echo "=== E2. DISPATCHER BREAKDOWN (card 3906d77b) -- self-advance vs mikrob-dispatch vs unattributed ==="
cardG=ffff0000000000000000000000000000000007  # dispatcher=self-advance
cardH=ffff0000000000000000000000000000000008  # dispatcher=mikrob-dispatch
...
$(now_fmt "$now_epoch")	$cardH	LOCAL	all-stages-passed	calls=1	chars=40	dispatcher=mikrob-dispatch
...
assert_field "$out" dispatcher_mikrob_dispatch 1 "E2: exactly one attributed to mikrob-dispatch"
