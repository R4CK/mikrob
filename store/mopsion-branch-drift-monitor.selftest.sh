#!/usr/bin/env bash
# mopsion-branch-drift-monitor.selftest.sh -- controls for mopsion-branch-drift-monitor.sh
...
MONITOR="$HERE/mopsion-branch-drift-monitor.sh"
...
echo "mopsion-branch-drift-monitor.sh selftest (card cf3c25ea)"
