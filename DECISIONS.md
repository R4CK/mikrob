...
## 2026-09-18 -- Plan-grilling 32dbac1e: CleanCore -> mopsion rebrand, staged, szimlink-kompatibilis

Verdikt: GO-WITH-CHANGES (MikroB, a backend3 grilling-elemzése alapján, komment 4247). A big-bang átnevezés elvetve: 8 élő ügynök hordozza a régi scriptneveket a session-kontextusában (a CLAUDE.md 17. szabálya szó szerint beégeti a suite-run parancsútját), egy systemd unit aktívan fut, 390 kártyacím érintett (ebből 8 élő), és egy élő kanban write-path normalizátor (src/web/routes/kanban.ts CANONICAL_PROJECTS) a project mezőt örökre CleanCore-ra írná vissza a címek átírása után is.
