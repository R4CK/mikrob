...
bash /home/neon/marveen/store/fleet-test.sh --ref <sha> src/__tests__/x.test.ts --reporter=verbose
# tsc az állandó worktree-ben (a script maga cwd-t vált /home/neon/marveen-test-re):
cd /home/neon/marveen-test && npx tsc --noEmit 2>&1 | grep -E "error TS" | head -20
```
NINCS cleanup -- a `/home/neon/marveen-test` szándékosan maradandó (elsőre létrehozza, utána
