...
## Instructions
1. **Scope first.** Confirm the target path and what Peti wants: code scan, dependency assessment, compliance check, or a full audit.
...
8. Use `--json --output <file>` when Peti needs a report artifact or CI integration.
...
**Example 1**
- Input (Peti): "Nézd át ezt a projektet, van-e benne hardcoded secret vagy SQL injection."
...
**Example 2**
- Input (Peti): "Készíts SOC 2 compliance riportot a repóról."
...
## Language rules
- Speak Hungarian with Peti (the user) — explanations, summaries, recommendations.
...
- Avoid running scanners against targets Peti hasn't authorized — this skill is for the team's own codebase.
