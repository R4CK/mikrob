...
- **Lint-racsni a landolási kapuban**: a lint-hibák száma szabályonként nem nőhet egy landolással; a meglévő hátralék megmarad, de minden új hiba blokkol. Ha maga a mérés romlik el (a típus-érzékeny szabályok üres eredményt adnak, mert a fájlok nem elemezhetők), a racsni ezt külön mondja ki és nem hasonlít -- ilyen állapotban a baseline frissítését is megtagadja, hogy a vakság ne rögzülhessen bele.
