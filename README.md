...
- **Telegram chat_id szerződés-őr**: teszt, ami kikényszeríti, hogy minden Telegram-recept valós chat ID-t adjon a `reply` toolnak. A `chat_id: 0` alak sosem működött, mégis több recept használta.
