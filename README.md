...
- **Landolási teljes-suite bizonyíték kapu**: a push előtt megkérdezi, hogy egy gate teljes suite-futásának bizonyítéka (nem csak célzott teszteké) még mindig ugyanazt a fát írja-e le, amit a merge éppen pusholna -- tartalom szerint, nem sha-egyenlőséggel, ugyanúgy tolerálva a landolásonkénti ártalmatlan zajt (verziószám, doksi), mint a Gate-SHA egyezés. Hiányzó bizonyíték vagy egyet nem értő tartalom megállítja a landolást; a teljes suite-ot maga a kapu sosem futtatja újra.
