...
- **Selftest-felfedezés**: minden `store/*.selftest.sh` automatikusan lefut a suite-ban, felfedezés alapján -- nem kézzel írt wrapperenként. Egy újonnan hozzáadott selftest a landolása pillanatában be van kötve, nincs mit elfelejteni. A ritka kivételt indoklás nevezi meg, és egy teszt kiköti, hogy a kivétel-bejegyzés célja még létezzen. Enélkül a megírt, zöldnek látszó ellenőrzések évekig futhatnak nulla alkalommal.
