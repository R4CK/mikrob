...
//
// WHY THE BUILD WRITES IT. update.sh's self-heal block (around the
// BUILT_COMMIT/NEW_VERSION_FULL comparison, ~line 904-909 on this fork) uses
// dist/.built-commit as the staleness detector for the "git=NEW + dist=OLD"
// self-heal: a missing or
