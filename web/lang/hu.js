...
window._i18n.hu = {
  ...
  'overview.quota.help.p1':         'A heti "All models" százalékot egy dinamikus küszöbhöz hasonlítjuk, ami a heti reset-ig hátralévő napok számától függ: 3 napnál távolabbi resetnél a legalacsonyabb küszöb érvényes, 2 napon belül magasabb, 1 napon belül a legmagasabb — minél közelebb a reset, annál nagyobb a megengedett mozgástér, hiszen úgyis hamarosan nullázódik.',
  'overview.quota.help.p2':         'Amint a heti százalék eléri az aktuális küszöböt, a flotta leállítja ÚJ fejlesztés indítását. A már futó kártyák és a QA/Cybersec/Cybered gate-jeik zavartalanul befejeződnek, a Telegram-válaszok és a monitorozás is tovább működik.',
  'overview.quota.help.p3':         'Küszöb felett a flotta lokális-LLM offload módra vált: a mechanikus, jól körülhatárolt kódrészleteket a helyi modell draftolja Claude-token égetése helyett, minden draftot a reset után online visszaellenőrzünk, mielőtt élesbe mehetne.',
  'overview.quota.help.p4':         'Az alábbi három csúszkával egy superadmin közvetlenül szerkesztheti ezeket a küszöböket — a változás a flotta konfigjába íródik, amit a dashboard és a dispatch-gate script egyaránt onnan olvas, így sosem csúsznak el egymástól.',
