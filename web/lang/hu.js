...
window._i18n.hu = {
  ...
  'overview.quota.modeltier.hint':     'A lánc sorrendje adja a lépcsőket: az első elem az elsődleges modell, minden következő egy szinttel olcsóbb. A heti % emelkedésével minden szerep-ügynök lelép a láncon; a resetkor visszaáll az elsődlegesre. A mikrob-channels kivétel.',
  'overview.quota.modeltier.chainTitle': 'Modell-lánc (sorrend = lépcsők)',
  'overview.quota.modeltier.addModel': '+ Modell hozzáadása',
  'overview.quota.modeltier.save':     'Mentés',
  'overview.quota.modeltier.saved':    'Mentve.',
  'overview.quota.modeltier.primaryTag': 'elsődleges',
  'overview.quota.modeltier.primaryPlaceholder': 'elsődleges modell azonosító',
  'overview.quota.modeltier.stepPlaceholder': 'olcsóbb modell azonosító',
  'overview.quota.modeltier.modelAria': '{n}. modell a láncban',
  'overview.quota.modeltier.moveUp':   'Feljebb',
  'overview.quota.modeltier.moveDown': 'Lejjebb',
  'overview.quota.modeltier.removeModel': 'Modell eltávolítása',
  'overview.quota.modeltier.errMinChain': 'A láncnak legalább 2 modellt kell tartalmaznia (elsődleges + legalább egy olcsóbb visszalépés).',
