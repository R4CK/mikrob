...
window._i18n.hu = {
  ...
  'overview.quota.strip_title':     'Előfizetési keret',
  ...
  'overview.quota.title':            'Claude Limit',
  'overview.quota.empty':           'Nincs rögzített heti %. Add meg a Claude usage-képernyőn látható heti értéket (All models).',
  'overview.quota.auto_empty':      'Nincs adat — a panel olvasó automatikusan frissíti.',
  'overview.quota.row.weekly':      'Heti (All)',
  'overview.quota.row.session':     'Session',
  'overview.quota.row.fable':       'Fable',
  'overview.quota.source.panel':    'panel',
  'overview.quota.source.oauth':    'oauth',
  'overview.quota.source.manual':   'manuális',
  'overview.quota.pctLabel':        'Heti % (0–100)',
  'overview.quota.resetLabel':      'Reset (opcionális)',
  'overview.quota.save':            'Mentés',
  'overview.quota.edit':            '% frissítése',
  'overview.quota.resets':          'Reset: {at}',
  'overview.quota.updated':         'Frissítve {rel}',
  'overview.quota.error':           'Nem elérhető',
  'overview.quota.saveError':       'A mentés sikertelen.',
  'overview.quota.help_aria':       'Küszöb-szabályok',
  'overview.quota.help.title':      'Heti küszöb-szabályok',
  'overview.quota.help.p1':         'Két, egymástól független küszöb van, a heti reset-ig hátralévő időtől FÜGGETLENÜL.',
  'overview.quota.help.p2':         '"Új fejlesztés leáll" (alap 90%): nem indul új planned-kártya dispatch, a folyamatban lévő munka és a gate-ek még befejeződnek, a mechanikus kódrészek lokális-LLM offloadra kerülnek.',
  'overview.quota.help.p3':         '"Tesztelés/ellenőrzés is leáll" (alap 97%, magasabbnak kell lennie mint az előző): ennél már a QA/Cybersec/Cybered gate-munka is leáll, minden szerep-ügynök parkolva -- csak MikroB marad élve.',
  'overview.quota.help.p4':         'A két küszöb a panel alsó részében szerkeszthető.',
  'overview.quota.threshold.toggle':'Küszöbök szerkesztése',
  'overview.quota.threshold.gt3':   '> 3 nap a resetig',
  'overview.quota.threshold.lt2':   '< 2 nap a resetig',
  'overview.quota.threshold.lt1':   '< 1 nap a resetig',
  ...
  'overview.quota.modeltier.toggle':   'Modell-lépcső (heti %)',
  'overview.quota.modeltier.enable':   'Heti modell-lépcső bekapcsolva',
  'overview.quota.modeltier.tier1':    '1. lépcső (egy szinttel olcsóbb)',
  'overview.quota.modeltier.tier2':    '2. lépcső (még egy szinttel olcsóbb)',
  'overview.quota.modeltier.hint':     'Minden ügynök a SAJÁT alap-modelljéről lép egy szintet lejjebb a közös modell-létrán (képesség szerint csökkenő rangsor), tier-enként egyet. A heti % emelkedésével lelép, a resetkor a saját alapjára áll vissza. A létra a modellválasztó listával közös forrásból jön. A mikrob-channels kivétel.',
  'overview.quota.modeltier.stateTitle': 'Ügynökök állapota (csak olvasható)',
  'overview.quota.modeltier.stateEmpty': 'Nincs megjeleníthető ügynök.',
  'overview.quota.modeltier.stateError': 'Az ügynök-állapot betöltése sikertelen.',
  'overview.quota.modeltier.exemptTag': 'kivétel',
  'overview.quota.modeltier.tierTag':  '{n}. lépcső',
  'overview.quota.modeltier.stateAria': 'Alap: {base}, jelenlegi: {current}, cél a heti lépcsőn: {target}.',
  'overview.quota.modeltier.save':     'Mentés',
  'overview.quota.modeltier.saved':    'Mentve.',
  'overview.quota.llm.title':       'Helyi LLM',
  'overview.quota.llm.helpAria':    'Megspórolt-token számítás',
  'overview.quota.llm.helpTitle':   'Megspórolt-token számítás',
  'overview.quota.llm.helpBody':    'A számítás a helyi modell TÉNYLEGES prompt- és kimeneti-token számát összegzi minden valós, sikeres hívásra -- nem becslés. Ezek a tokenek a Claude-kvótán FELÜL, a helyi GPU-n futottak le, tehát annyi Claude-tokent takarítottak meg, amennyit egy azonos méretű online hívás használt volna.',
  'overview.quota.llm.model':       'Modell',
  'overview.quota.llm.today':       'Ma',
  'overview.quota.llm.week':        'Ezen a héten',
  'overview.quota.llm.tokensSaved': 'Megspórolt token',
  'overview.quota.llm.count':       '{n} feladat',
  'overview.quota.llm.pending':     'Hamarosan',
  'overview.quota.llm.error':       'Nem sikerült betölteni a helyi-LLM statisztikát.',
  ...
  'federation.tailscale.title':        'Kapcsolódási adataim',
  'federation.tailscale.hint':         'Ezt az azonosítót és címet add át a másik rendszer adminjának, hogy felvehessen társnak.',
  'federation.tailscale.login_btn':    'Bejelentkezés Tailscale-lel',
  'federation.tailscale.retry_btn':    'Újra',
  'federation.tailscale.pending':      'Csatlakozás folyamatban...',
  'federation.tailscale.open_login_btn': 'Bejelentkezési link megnyitása',
  'federation.tailscale.popup_blocked': 'A böngésző letiltotta az automatikus felugró ablakot -- nyisd meg kézzel a lenti gombbal.',
  'federation.tailscale.system_id_label': 'Rendszer-azonosító',
  'federation.tailscale.base_url_label':  'Elérési cím',
  'federation.tailscale.copy_btn':     'Másolás',
  'federation.tailscale.copied':       'Vágólapra másolva',
  'federation.tailscale.manual_hint':  'Ha a Tailscale nincs telepítve ezen a gépen, vagy az automatikus lépés nem működik, a docs/mobil-dashboard.md kézi lépései is elérhetők.',
  'federation.tailscale.error_generic': 'A Tailscale-kapcsolódás nem sikerült. Próbáld újra, vagy nézd meg a docs/mobil-dashboard.md kézi lépéseit.',
  ...
  'kanban.diff.title':                'Diff és soron belüli kommentek',
  'kanban.diff.collapse':             'Összezár',
  'kanban.diff.expand':               'Kinyit',
  'kanban.diff.empty':                'Ehhez a kártyához még nincs diff-komment.',
  'kanban.diff.error':                'A diff nem tölthető be.',
  'kanban.diff.add_comment_ph':       'Soron belüli megjegyzés...',
  'kanban.diff.add_btn':              'Küldés',
  'kanban.diff.cancel_btn':           'Mégse',
  'kanban.diff.delete_btn':           'Törlés',
  ...
  'kanban.deps.no_successors':      'Egyetlen kártya sem vár erre.',
  'kanban.deps.search_placeholder': 'Kártya keresése cím szerint...',
  'kanban.deps.add_btn':            'Függőség hozzáadása',
  'kanban.deps.remove_btn':         'Függőség törlése',
  'kanban.deps.added':              'Függőség hozzáadva',
  'kanban.deps.removed':            'Függőség törölve',
  'kanban.deps.blocking':           '(blokkol)',
  'kanban.deps.priority_saved':     'A blokkoló kártya prioritása mentve',
  'kanban.deps.pick_from_list':     'Válassz egy kártyát a listából (a név mellett a kártya azonosítója áll).',
  'kanban.deps.blocked_toast':      'Nem léphet tovább: előbb ezeknek kell elkészülniük -- {titles}',
  ...
  'agents.hud.context_label':      'Kontextus',
  'agents.hud.context_disabled':   'Kontextus-mérés kikapcsolva',
  'agents.hud.active_model':       'Aktív: {model}',
  ...
  'memories.graph.rel.toggle':   'Kanban-relációk',
  'memories.graph.rel.card':     'Kártya',
  'memories.graph.rel.file':     'Fájl',
  'memories.graph.rel.decision': 'Döntés',
  'memories.graph.rel.other':    'Egyéb',
  'memories.graph.rel.loading':  'Kanban-relációk betöltése...',
  'memories.graph.rel.empty':    'A betöltött emlékek nem hivatkoznak relációval rendelkező kanban-kártyára. Válts ügynök-szűrőt, vagy keress kártya-azonosítót tartalmazó emléket.',
  'memories.graph.rel.error':    'A kanban-relációk nem tölthetők be. Próbáld újra; ha nem segít, ellenőrizd, hogy fut-e a dashboard-szerver.',
  'memories.graph.rel.offline':  'Nincs hálózati kapcsolat, a kanban-relációk nem tölthetők be. Kapcsolódj újra, majd próbáld újra.',
  'memories.graph.rel.retry':    'Újra',
  'memories.graph.rel.close':    'Bezárás',
  'memories.graph.rel.open_card': 'Megnyitás a kanbanon',
  'memories.graph.rel.card_missing': 'Ez a kártya már nem létezik (törölve vagy archiválva).',
  'memories.graph.rel.card_load_error': 'A kártya adatai nem tölthetők be. Próbáld újra.',
  'memories.graph.rel.mentions': '{n} emlék hivatkozik rá',
  'memories.graph.rel.touched_by': '{n} kártya érintette',
  'memories.graph.rel.connections': '{n} kapcsolat',
  ...
  'conversation.session_label':  'Session:',
  'conversation.session_newest': 'Legújabb session',
  'conversation.session_entries':'{count} bejegyzés',
  'conversation.sessions_error': 'Session-lista nem érhető el',
  ...
  // --- Local LLM (Ollama offload) ---
  'localLlm.page_title':         'Lokális LLM',
  'localLlm.page_subtitle':      'A helyi offload modell (Ollama a WSL GPU-n) vezérlése',
  'localLlm.btn.refresh':        'Frissítés',
  'localLlm.load_error':         'A helyi LLM adatai nem tölthetők be.',
  'localLlm.offload.title':      'Offload agresszivitás',
  'localLlm.offload.desc':       'Mennyi mechanikus kód-részt adjunk ki a helyi GPU-nak. Magasabb érték = több offload, kevesebb Claude-token.',
  'localLlm.offload.off':        'Ki (0)',
  'localLlm.offload.max':        'Max (100)',
  'localLlm.offload.optimal':    'Optimum',
  'localLlm.offload.saved':      'Mentve: {value}',
  'localLlm.offload.save_error': 'A mentés nem sikerült, próbáld újra.',
  ...
  'localLlm.offload.ramp.reason.manual': 'Kézi felülbírálás aktív — az automatikus rámpa nem vezérli az agresszivitást.',
  'localLlm.offload.ramp.reason.atThreshold': 'A heti kvóta elérte a küszöböt — az agresszivitás maximumon (100).',
  'localLlm.offload.ramp.reason.ramping': 'Az automatikus rámpa a heti kvóta szerint emeli az agresszivitást a küszöb felé.',
  'localLlm.offload.ramp.reason.floor': 'Automatikus mód, alap agresszivitáson — a heti kvóta még nem emeli.',
  'localLlm.offload.difficulty.label': 'Kódolási nehézségi küszöb',
  'localLlm.offload.difficulty.desc': 'A legnehezebb kódolási feladat, ami még helyben draftolható. Magasabb küszöb = nehezebb feladatok is a helyi modellen futnak.',
  'localLlm.offload.difficulty.auto': 'Automatikus (a csúszkából)',
  'localLlm.offload.difficulty.trivial': 'Triviális — snippet / regex / formázás',
  'localLlm.offload.difficulty.isolated': 'Izolált — függvény / teszt / típus',
  'localLlm.offload.difficulty.module': 'Modul — több-függvényes (egy fájl)',
  'localLlm.offload.difficulty.feature': 'Feature — több-fájlos',
  'localLlm.offload.difficulty.architecture': 'Architektúra / wiring',
  'localLlm.offload.difficulty.level.trivial': 'triviális',
  'localLlm.offload.difficulty.level.isolated': 'izolált',
  'localLlm.offload.difficulty.level.module': 'modul',
  'localLlm.offload.difficulty.level.feature': 'feature',
  ...
  'localLlm.categories.title':   'Kategóriák',
  'localLlm.categories.desc':    'Az összes helyi-offload feladattípus, élőben a routerből — nem csak a kódolási nehézség. Kikapcsolt kategória a dashboardról: az adott feladat innentől online (Claude) fut.',
  'localLlm.categories.empty':   'Nincs kategória a helyi routerben.',
  'localLlm.categories.on':      'Be',
  'localLlm.categories.off':     'Ki',
  'localLlm.categories.infoAria': '{task} leírása',
  'localLlm.categories.meta_used': '{count} hívás · utoljára: {when}',
  'localLlm.categories.meta_unused': 'Még nem hívták',
  'localLlm.categories.enabled_msg': 'Kategória bekapcsolva: {task}',
  'localLlm.categories.disabled_msg': 'Kategória kikapcsolva: {task} — ez a feladattípus mostantól online fut.',
  'localLlm.categories.save_error': 'A kategória mentése nem sikerült, próbáld újra.',
  'localLlm.routing.title': 'Feladat-routing',
  'localLlm.routing.desc': 'Melyik feladattípus melyik modellre megy, és miért. A kapcsoló valódi: kikapcsolt preset innentől online (Claude) fut.',
  'localLlm.routing.summary': 'Alapértelmezett modell: {model} · nehézségi küszöb: {threshold} · agresszivitás: {aggr}',
  'localLlm.routing.endpoint_missing': 'A routing-döntések végpontja még nem elérhető (BE-kártya ecf38e5a). A preset-kapcsolók működnek; a modell-oszlop és a két panel a végpont landolása után töltődik.',
  'localLlm.routing.endpoint_missing_short': 'A routing-adat még nem elérhető.',
  'localLlm.routing.endpoint_error': 'A routing-adat nem tölthető be. Frissítsd az oldalt; ha marad, nézd meg a szerver naplóját.',
  'localLlm.routing.route_default': 'alapértelmezett',
  'localLlm.routing.route_override': 'override',
  'localLlm.routing.route_default_tip': 'Ez a preset a store/local-llm-model alapértelmezett modelljére megy.',
  'localLlm.routing.route_override_tip': 'Ehhez a presethez a local-llm-model-routing.json külön modellt rendel.',
  'localLlm.routing.route_unknown': 'modell: nem ismert',
  'localLlm.routing.route_online_now': 'kikapcsolva → online',
  'localLlm.routing.always_online_title': 'Mindig online',
  'localLlm.routing.always_online_desc': 'Ezeket a kategóriákat a router sosem adja a helyi modellnek, a csúszkától függetlenül.',
  'localLlm.routing.always_online_empty': 'Nincs mindig-online kategória a routerben.',
  'localLlm.routing.ceiling_never': 'soha nem helyi',
  'localLlm.routing.ceiling_upto': 'helyi legfeljebb: {level}',
  'localLlm.routing.decisions_title': 'Utolsó kártya-döntések',
  'localLlm.routing.decisions_desc': 'A card-build-route döntései dispatch-időben: helyi draft vagy online, és az ok.',
  'localLlm.routing.decisions_empty': 'Még nincs kártya-döntés a naplóban.',
  'localLlm.routing.decisions_unavailable': 'A döntésnapló (card-build-route.log) nem olvasható.',
  'localLlm.routing.verdict_local': 'HELYI',
  'localLlm.routing.verdict_online': 'ONLINE',
  'localLlm.routing.verdict_decomposed': 'RÉSZBEN HELYI',
  'localLlm.routing.decision_calls': '{n} modellhívás',
  'localLlm.routing.decisions_window': 'utolsó {hrs} óra',
  'localLlm.routing.summary_decomposed': 'RÉSZBEN HELYI: {n}',
  'localLlm.routing.decision_decompose': '{n} részfeladat-jelölt: {types}',
  'localLlm.routing.reason.priority_high': 'Magas prioritás',
  'localLlm.routing.reason.priority_urgent': 'Sürgős',
  'localLlm.routing.reason.deterministic_multi_decision': 'Több döntési pont',
  'localLlm.routing.reason.deterministic_object_integrity': 'Objektum-integritás',
  'localLlm.routing.reason.all_stages_passed': 'Minden fázis helyi',
  'localLlm.routing.reason.steering_attempt': 'Irányítási kísérlet',
  'localLlm.models.summary': '{installed} telepített modell · {disabled} letiltva',
  'localLlm.models.summary_offline': '{installed} ismert modell (az Ollama nem fut) · {disabled} letiltva',
  'localLlm.models.route_default': 'alapértelmezett: minden más preset',
  'localLlm.models.route_presets': '{n} preset ide irányítva',
  'overview.llmDist.lane_disabled': 'Letiltva',
  'overview.llmDist.lane_open': 'Megnyitás a Lokális LLM oldalon',
  'overview.llmDist.tooltip.routing': 'Routing',
  'overview.llmDist.tooltip.routing_override': 'override → {model}',
  'overview.llmDist.tooltip.routing_default': 'alapértelmezett modell ({model})',
  'localLlm.status.title':       'Állapot',
  'localLlm.status.ollama':      'Ollama',
  'localLlm.status.up':          'Fut',
  ...
  'localLlm.status.embed_model_role': 'Memória-keresés, vektorizálás (RAG)',
  'localLlm.status.in_vram':         'VRAM-ban betöltve',
  'localLlm.status.not_in_vram':     'Nincs VRAM-ban',
  'localLlm.status.bridge':      'Ghost quota-bridge',
  'localLlm.status.running':     'Fut',
  'localLlm.status.stopped':     'Leállítva',
  'localLlm.status.gpu':         'GPU',
  'localLlm.status.no_gpu':      'Nincs GPU-adat',
  'localLlm.models.title':       'Modellek',
  'localLlm.models.empty':       'Nincs letöltött modell.',
  'localLlm.models.active':      'Aktív',
  'localLlm.models.use':         'Aktiválás',
  'localLlm.models.update':      'Frissítés',
  'localLlm.models.pull_placeholder': 'pl. qwen2.5-coder:7b',
  'localLlm.models.pull_btn':    'Letöltés',
  'localLlm.models.pull_empty':  'Add meg a modell nevét.',
  'localLlm.models.pull_starting': 'Letöltés indítása...',
  'localLlm.models.pulling':     'Letöltés folyamatban',
  'localLlm.models.pull_done':   'Letöltve: {model}',
  'localLlm.models.pull_failed': 'A letöltés nem sikerült.',
  'localLlm.models.swapped':     'Aktív modell: {model}',
  'localLlm.models.disabled_badge': 'Letiltva',
  'localLlm.models.toggle.enable': 'Engedélyezés',
  'localLlm.models.toggle.disable': 'Letiltás',
  'localLlm.models.toggle.enable_tip': 'A modell újra használható a helyi routing számára.',
  'localLlm.models.toggle.disable_tip': 'A routing és a queue nem választja ezt a modellt, amíg le van tiltva.',
  'localLlm.models.toggle.saved_on': '{model} engedélyezve',
  'localLlm.models.toggle.saved_off': '{model} letiltva -- a helyi routing nem használja',
  ...
  'localLlm.models.bench.unmeasured_hint': 'Nem mért. Futtatsd: store/local-llm-bench.sh',
  'localLlm.test.title':         'Gyorsteszt',
  'localLlm.test.hint':          'Próbáld ki a helyi modellt a RAG wrapperen keresztül (mikrob memóriával).',
  'localLlm.test.placeholder':   'Írj egy promptot...',
  'localLlm.test.run_btn':       'Futtatás',
  'localLlm.test.empty':         'Üres a prompt.',
  'localLlm.test.running':       'A helyi modell dolgozik...',
  'localLlm.test.no_output':     '(nincs kimenet)',
  'localLlm.logs.title':         'Terminál és futó feladatok',
  'localLlm.logs.bridge':        'Quota-bridge',
  'localLlm.logs.ollama':        'Ollama',
  'localLlm.logs.empty':         '(nincs naplóbejegyzés)',
  'localLlm.running.none':       'Jelenleg nincs futó generálás.',
  'localLlm.running.vram':       'VRAM',
  'localLlm.usage.title':        'Használat',
  'localLlm.usage.total':        'Összes hívás',
  'localLlm.usage.today':        'Ma',
  'localLlm.usage.last_7d':      'Utolsó 7 nap',
  'localLlm.usage.by_agent':     'Ügynökök szerint',
  'localLlm.usage.by_source':    'Forrás és feladat szerint',
  'localLlm.usage.by_day':       'Utolsó 14 nap',
  'localLlm.usage.recent':       'Aktivitás (mai nap)',
  'localLlm.usage.none':         'Még nincs rögzített hívás.',
  'localLlm.usage.source_bare':  'Közvetlen (bare)',
  'localLlm.usage.source_rag':   'RAG wrapper',
  'localLlm.usage.code_calls':   'Kódolási hívások',
  'localLlm.usage.ui_probes':    'UI próba (kizárva)',
  'localLlm.usage.status_ok':    'Sikeres',
  'localLlm.usage.status_err':   'Hibás',
  'localLlm.usage.col_time':     'Időpont',
  'localLlm.usage.col_agent':    'Ügynök',
  'localLlm.usage.col_task':     'Feladat',
  'localLlm.usage.col_source':   'Forrás',
  'localLlm.usage.col_ms':       'ms',
  'localLlm.usage.col_status':   'Állapot',
  'localLlm.rec.title':          'Ajánlott modellek',
  'localLlm.rec.hint':           'A legjobb kódmodellek erre a GPU-ra (GTX 1660 Ti, 6 GB VRAM). Az ~5 GB feletti modellek CPU-ra csúsznak és lassabbak.',
  'localLlm.rec.gpu_hint':       'GPU-hoz szűrt, ellenőrzött katalógus -- {name} ({vram} VRAM).',
  'localLlm.rec.gpu_unknown':    'ismeretlen GPU',
  'localLlm.rec.cpu_only_hint':  'Nem található GPU -- a lista csak CPU-n futtatható, kisebb modelleket mutat.',
  'localLlm.rec.stale_banner':   'A katalógus nem frissült most élőben (hálózat vagy limit) -- a legutóbb sikeresen lekért adat látszik.',
  'localLlm.rec.load_error':     'A modell-katalógus nem tölthető be.',
  'localLlm.rec.empty':          'Nincs a GPU-hoz illő modell a katalógusban.',
  'localLlm.rec.pull_btn':       'Letöltés',
  'localLlm.rec.use_btn':        'Aktiválás',
  'localLlm.rec.activate_error': 'Az aktiválás nem sikerült -- a modell nincs letöltve, vagy az Ollama nem elérhető.',
  'localLlm.rec.fit_fits':       'Fér',
  'localLlm.rec.fit_tight':      'Szoros (részben CPU-n)',
  'localLlm.rec.trust.trusted':          'Ellenőrzött kiadó',
  'localLlm.rec.trust.trusted_tip':      'A kiadó a bizalmi allowlistán szerepel (nem ugyanaz, mint a relevancia-szűrés).',
  'localLlm.rec.trust.unverified':       'Nem ellenőrzött',
  'localLlm.rec.trust.unverified_tip':   'A kiadó nincs a bizalmi allowlistán -- körültekintően telepítsd.',
  'localLlm.rec.downloads_tip':  'Letöltésszám a HuggingFace-en',
  'localLlm.rec.digest_tip':     'Az első fájlrész SHA-256 digest-jének eleje',
  'localLlm.rec.recommended':        'Ajánlott',
  'localLlm.rec.recommended_tip':    'A legjobb illeszkedés, ellenőrzött kiadó és letöltésszám alapján kiválasztott alapértelmezett modell.',
  'localLlm.rec.variant_select_aria': 'Kvantálási változat -- {name}',
  ...
  'localLlm.hf.title':           'HuggingFace keresés',
  'localLlm.hf.hint':            'Keress GGUF kódmodelleket a HuggingFace-en; a GGUF találatok közvetlenül húzhatók Ollamába.',
  'localLlm.hf.query_placeholder': 'Keresés (pl. qwen coder, deepseek)',
  'localLlm.hf.task_label':      'Feladat',
  'localLlm.hf.task_codegen':    'Szöveggenerálás (kód)',
  'localLlm.hf.task_any':        'Bármely',
  'localLlm.hf.sort_label':      'Rendezés',
  'localLlm.hf.sort_downloads':  'Letöltések',
  'localLlm.hf.sort_likes':      'Kedvelések',
  'localLlm.hf.sort_trending':   'Trending',
  'localLlm.hf.sort_recent':     'Legutóbbi',
  'localLlm.hf.gguf_only':       'Csak GGUF (Ollama húzható)',
  'localLlm.hf.search_btn':      'Szűrés indítása',
  'localLlm.hf.searching':       'Keresés a HuggingFace-en...',
  'localLlm.hf.empty':           'Nincs találat. Módosíts a szűrőkön és próbáld újra.',
  'localLlm.hf.error':           'A HuggingFace keresés nem sikerült. Ellenőrizd a hálózatot és próbáld újra.',
  'localLlm.hf.initial':         'Indíts egy keresést a fenti szűrőkkel.',
  'localLlm.hf.result_count':    '{count} találat',
  'localLlm.hf.dl':              'letöltés',
  'localLlm.hf.likes':           'kedvelés',
  'localLlm.hf.gguf_badge':      'GGUF',
  'localLlm.hf.not_gguf':        'nem GGUF – Ollama nem húzza',
  'localLlm.hf.pull_btn':        'Húzás',
  ...
  'localLlm.queue.tile.failed':  'Sikertelen',
  'localLlm.queue.tile.latency': 'Átlagos idő',
  'localLlm.queue.recent':       'Legutóbbi tételek',
  'localLlm.queue.filter.all':      'Mind',
  'localLlm.queue.filter.pending':  'Várakozó',
  'localLlm.queue.filter.running':  'Fut',
  'localLlm.queue.filter.done':     'Kész',
  'localLlm.queue.filter.failed':   'Sikertelen',
  'localLlm.queue.filter.aria':     'Szűrés státusz szerint',
  'localLlm.queue.col_time':     'Létrehozva',
  'localLlm.queue.col_agent':    'Ügynök',
  'localLlm.queue.col_task':     'Feladat',
  'localLlm.queue.col_priority': 'Prioritás',
  'localLlm.queue.col_status':   'Státusz',
  'localLlm.queue.col_source':   'Forrás',
  'localLlm.queue.col_ms':       'ms',
  'localLlm.queue.col_state':    'Állapot',
  'localLlm.queue.col_action':   'Eredmény',
  'localLlm.queue.view_btn':     'Megnézés',
  'localLlm.queue.none':         'Üres a feladatsor.',
  'localLlm.queue.load_error':   'A feladatsor nem tölthető be. Próbáld újra.',
  'localLlm.queue.status.pending': 'Várakozó',
  'localLlm.queue.status.running': 'Fut',
  'localLlm.queue.status.done':    'Kész',
  'localLlm.queue.status.failed':  'Sikertelen',
  'localLlm.queue.detail.title':     'Feladat-sor tétel',
  'localLlm.queue.detail.agent':     'Ügynök',
  'localLlm.queue.detail.task':      'Feladat-típus',
  'localLlm.queue.detail.template':  'Sablon',
  'localLlm.queue.detail.priority':  'Prioritás',
  'localLlm.queue.detail.status':    'Státusz',
  'localLlm.queue.detail.attempts':  'Próbálkozások',
  'localLlm.queue.detail.card':      'Kártya',
  'localLlm.queue.detail.created':   'Létrehozva',
  'localLlm.queue.detail.started':   'Elindult',
  'localLlm.queue.detail.finished':  'Befejeződött',
  'localLlm.queue.detail.result':    'Eredmény',
  'localLlm.queue.detail.error':     'Hiba',
  'localLlm.queue.detail.no_result': 'Még nincs eredmény.',
  'localLlm.queue.detail.load_error': 'A tétel nem tölthető be. Próbáld újra.',
  ...
  'settings.module.integrations': 'Integrációk',
  'settings.module.security':    'Biztonság',

  // Integrations tab — Gemini API key
  'integrations.gemini.title':          'Gemini API',
  'integrations.gemini.desc':           'Google Gemini API kulcs -- a modell-hívásokhoz szükséges.',
  'integrations.gemini.status.set':     'Kulcs beállítva',
  'integrations.gemini.status.unset':   'Nincs kulcs megadva',
  'integrations.gemini.input.label':    'API kulcs',
  'integrations.gemini.input.ph':       'AIza...',
  'integrations.gemini.btn.save':       'Mentés',
  'integrations.gemini.btn.saving':     'Mentés...',
  'integrations.gemini.btn.delete':     'Törlés',
  'integrations.gemini.btn.deleting':   'Törlés...',
  'integrations.gemini.btn.show':       'Megjelenítés',
  'integrations.gemini.btn.hide':       'Elrejtés',
  'integrations.gemini.saved':          'Kulcs sikeresen mentve.',
  'integrations.gemini.deleted':        'Kulcs törölve.',
  'integrations.gemini.err.empty':      'A kulcs mező nem lehet üres.',
  'integrations.gemini.err.save':       'Mentés sikertelen. Próbáld újra.',
  ...
  'updates.integrated.title':    'Beépített repók frissessége',
  'updates.integrated.counts':   '{total} beépített repó: {fresh} naprakész, {behind} lemaradt ({review} átnézés előtt), {unknown} nem mérhető.',
  'updates.integrated.last_checked': 'Utolsó ellenőrzés: {date}',
  'updates.integrated.never_checked': 'Még egyik repó sem lett ellenőrizve.',
  'updates.integrated.never_count': '{n} repó még sosem lett ellenőrizve',
  'updates.integrated.behind_item': '{n} commit lemaradás',
  'updates.integrated.empty':    'A registry üres: nincs figyelt vagy beépített repó.',
  'updates.integrated.col.name': 'Repó',
  'updates.integrated.col.kind': 'Fajta · adoptálás',
  'updates.integrated.col.enabled': 'Engedélyezve',
  'updates.integrated.col.installed': 'Telepítve',
  'updates.integrated.col.last_checked': 'Utolsó ellenőrzés',
  'updates.integrated.col.state': 'Frissesség',
  'updates.integrated.col.note': 'Review-jegyzet',
  'updates.integrated.note_summary': 'Jegyzet ({n} karakter)',
  'updates.integrated.link':     'Kártyás nézet, frissítés-műveletekkel',
  'updates.integrated.error':    'A beépített repók frissessége most nem olvasható. Próbáld újra az Ellenőrzés gombbal, vagy nyisd meg a Beépített repók oldalt.',
  ...
  'repos.stat.total':            'Beépített repó',
  'repos.detect_info_box':       'Az adoptált repóknál a frissesség mért adat: utolsó ellenőrzés dátuma és az upstream-lemaradás commitban (naprakész / N commit lemaradás / nem mérhető). A dashboardról hozzáadott repóknál ilyen mérés nincs, ott a Frissítés gomb mindig lefuttatja a git pull-t.',
  'repos.stat.fresh':            'Naprakész',
  'repos.stat.behind':           'Lemaradt',
  'repos.stat.review':           'Átnézés előtt',
  'repos.stat.unknown':          'Nem mérhető',
  'repos.fresh.up_to_date':      'naprakész',
  'repos.fresh.up_to_date_title': 'A helyi másolat az upstream ág csúcsán áll (az utolsó ellenőrzés szerint).',
  'repos.fresh.unknown':         'nem mérhető',
  'repos.fresh.unknown_title':   'Nincs helyi upstream-referencia (pipx-telepítés, vagy még nem szinkronizált klón): a lemaradás innen nem állapítható meg.',
  'repos.last_checked_never':    'még nem történt',
  'repos.add_placeholder':       'https://github.com/felhasznalo/repo',
  'repos.add_btn':               'Hozzáadás',
  'repos.loading':               'Betöltés...',
  'repos.load_error':            'Hiba a repók betöltésekor',
  'repos.empty_msg':             'Még nincs beépített repó',
  'repos.empty_hint':            'Adj hozzá egyet a fenti mezővel',
  'repos.detect_pending_title':  'A frissítés-detektálás még nem elérhető (backend fejlesztés alatt)',
  'repos.badge.pending_check':   'Ellenőrzés hamarosan',
  'repos.badge.adopted':         'adoptált',
  'repos.tooltip.how':           'Beépítés',
  'repos.tooltip.aria':          'Információ a repóról',
  'repos.integ.vendored':        'vendorolt klón (repón kívül, napi sync)',
  'repos.integ.folded':          'elvekként a CLAUDE.md-be olvasztva',
  'repos.integ.manual':          'dashboardról hozzáadva (git klón)',
  'repos.update_available_badge': 'frissítés',
  'repos.update_available_msg':  'Frissítés elérhető: {n} új commit az upstreamen.',
  'repos.update_review_required': 'Átnézés szükséges a frissítés előtt (futtatható kód).',
  'repos.installed':             'telepítve',
  'repos.installed_title':       'Telepítve és használatban (adoptált külső fejlesztés)',
  ...
  'kanban.filter.priority_label':   'Dispatch-prioritás:',
  'kanban.filter.priority_default': 'Alap sorrend',
  'kanban.filter.priority_tooltip': 'A kiválasztott projektek kártyái mennek elöl minden dispatch-döntésnél, a felsorolás sorrendjében, amíg vissza nem áll Alap sorrendre.',
  'kanban.filter.priority_saved':   'Dispatch-prioritás beállítva: {project}',
  'kanban.filter.priority_cleared': 'Dispatch-prioritás törölve -- alap sorrend visszaállítva',
  'kanban.filter.priority_save_failed': 'Nem sikerült elmenteni a dispatch-prioritást -- próbáld újra.',
  'kanban.filter.priority_add':     '+ Projekt hozzáadása',
  'kanban.filter.priority_remove':  '{project} eltávolítása a prioritásból',
  ...
  'overview.cost.detail_link':    'Részletek →',
  'overview.cost.empty':          'Nincs tokenhasználati adat erre a napra.',
  'overview.cost.error':          'A becslés nem érhető el.',
  'overview.cost.usd':            '${amount}',
  'overview.cost.row_tps':        '{inputK}K be / {outputK}K ki token',
  'overview.cost.note_disclaimer':'Becsült összeg: token-volumen × listár. A tényleges számlázás eltérhet.',
  // LLM monitor page (card 87be1810)
  'llmMon.page_title':          'LLM monitor',
  'llmMon.page_subtitle':       'Feladat-idővonal ügynökönként, terhelés és modellhasználat a választott időablakban',
  'llmMon.window.label':        'Időablak',
  'llmMon.window.1h':           'Utolsó 1 óra',
  'llmMon.window.6h':           'Utolsó 6 óra',
  'llmMon.window.24h':          'Utolsó 24 óra',
  'llmMon.window.7d':           'Utolsó 7 nap',
  'llmMon.meta':                '{window}: {from} – {to}',
  'llmMon.kpi.active_models':   'Aktív modellek',
  'llmMon.kpi.tasks':           'Feladatok',
  'llmMon.kpi.failed_sub':      '{n} sikertelen',
  'llmMon.kpi.avg_duration':    'Átlagos feladat-idő',
  'llmMon.kpi.total_requests':  'Összes kérés',
  'llmMon.kpi.error_rate':      'Hibaarány',
  'llmMon.coverage_note':       'Idővonal-blokkot csak ezek a sávok tudnak rajzolni: {lanes}. Az online modellek munkája megszámolva, de feladatonkénti időtartamuk nincs tárolva.',
  'llmMon.truncated_note':      'Csak az első {n} feladat látszik ebben az ablakban -- szűkítsd az időablakot a teljes képhez.',
  'llmMon.empty':               'Nincs befejezett feladat ebben az ablakban ({window}).',
  'llmMon.error':               'Nem sikerült betölteni a feladat-adatokat. Próbáld újra, vagy válassz másik időablakot.',
  'llmMon.retry':               'Újra',
  'llmMon.swimlane.title':      'Feladat-idővonal (ügynökönként)',
  'llmMon.swimlane.scroll_hint':'A sáv a jelen pillanatnál nyílik. Húzd a csúszkát balra, hogy visszamenj az időben; kattints egy blokkra a részletekhez.',
  'llmMon.swimlane.legend_title':'Kategória',
  'llmMon.series.title':        'Terhelés-idősor',
  'llmMon.series.y_label':      'Elindított feladat / {bucket}',
  'llmMon.series.other':        'egyéb',
  'llmMon.modelSeries.title':   'Kérés-idősor modellenként',
  'llmMon.modelSeries.y_label': 'Kérés / {bucket}',
  'llmMon.modelSeries.empty':   'Nincs online-modell forgalom ebben az ablakban.',
  'llmMon.models.title':        'Modellek a választott ablakban',
  'llmMon.models.empty':        'Nincs modellhasználat ebben az ablakban.',
  'llmMon.models.col.model':    'Modell',
  'llmMon.models.col.requests': 'Kérés',
  'llmMon.models.col.tokens':   'Token (be / ki)',
  'llmMon.models.col.agents':   'Ügynök',
  'llmMon.detail.title':        'Feladat részletei',
  'llmMon.detail.category':     'Kategória',
  'llmMon.detail.agent':        'Ügynök',
  'llmMon.detail.status':       'Állapot',
  'llmMon.detail.duration':     'Időtartam',
  'llmMon.detail.started':      'Indult',
  'llmMon.detail.card':         'Kártya',
  'llmMon.detail.no_card':      'nincs kártyához kötve',
  'llmMon.detail.tokens_note':  'Token- és átviteli adat ehhez a feladathoz nincs rögzítve: a feladat-napló csak időtartamot tárol, a tokeneket a modellhasználat-napló külön méri.',
  'llmMon.detail.close':        'Bezárás',
  'llmMon.status.done':         'kész',
  'llmMon.status.failed':       'sikertelen',
  'llmMon.dur.ms':              '{n} ms',
  'llmMon.dur.sec':             '{n} mp',
  'llmMon.dur.min':             '{m}:{s} perc',
  'llmMon.bucket.min':          '{n} perc',
  'llmMon.bucket.hour':         '{n} óra',
  'overview.llmDist.title':             'Helyi LLM feladat-elosztás',
  'overview.llmDist.meta':              'utolsó {hours}',
  'overview.llmDist.range_label':       'Időablak',
  'overview.llmDist.range_minutes':     '{n} perc',
  'overview.llmDist.range_hours':       '{n} óra',
  ...
  'overview.llmDist.kpi.tokens_per_sec':'Token/mp',
  'overview.llmDist.kpi.total_requests':'Összes kérés',
  'overview.llmDist.kpi.error_rate':    'Hibaarány',
  'overview.llmDist.legend_title':      'Feladattípus',
  'overview.llmDist.tooltip.agent':     'Ügynök',
  'overview.llmDist.tooltip.duration':  'Időtartam',
  'overview.llmDist.tooltip.tokens':    'Tokenek',
  'overview.llmDist.tooltip.tokens_value': '{total} ({in} be / {out} ki)',
  'overview.llmDist.tooltip.throughput':'Áteresztés',
  'overview.llmDist.tooltip.status':    'Állapot',
  'overview.llmDist.status.ok':         'Sikeres',
  'overview.llmDist.status.err':        'Hiba',
  'overview.llmDist.status.busy':       'Foglalt',
  'overview.llmDist.ms':                '{n} ms',
  'overview.llmDist.sec':               '{n} mp',
  'overview.llmDist.tps':               '{n} t/mp',
  ...
  'names.title':                   'Kimenő-szűrés: nevek és kifejezések',
  'names.desc':                    'Ezeket a neveket/kifejezéseket a kimenő-szöveg kapu kiszűri a Telegram- és email-üzenetekből. A lista csak ezen a gépen él, sosem kerül a repóba.',
  'names.state.active':            'Aktív: {n} szabály betöltve.',
  'names.state.empty':             'A lista üres, tehát a névszűrés jelenleg nem szűr semmit.',
  'names.state.broken':            'A szabályfájl hiányzik vagy sérült, ezért a névellenőrzés NEM fut. Ezt javítani kell.',
  'names.mode.literal':            'Pontos szöveg',
  'names.mode.regex':              'Regex (haladó)',
  'names.mode_hint':               'A „Pontos szöveg” a beírt nevet betű szerint keresi. A „Regex” Python-mintát vár, és mentés előtt lefuttatjuk rajta ugyanazt az ellenőrzést, amit a kapu is végez.',
  'names.placeholder':             'Név vagy kifejezés',
  'names.add':                     'Hozzáadás',
  'names.remove':                  'Törlés',
  'names.confirm_remove':          'Biztosan törlöd ezt a szabályt? Ettől kezdve a kimenő szövegekben nem lesz kiszűrve.',
  'names.empty_list':              'Még nincs egyetlen szabály sem.',
  'names.added':                   'Felvéve. Mostantól {n} szabály van érvényben.',
  'names.removed':                 'Törölve. Mostantól {n} szabály van érvényben.',
  'names.err_empty':               'Írd be a szűrendő nevet vagy kifejezést.',
  'names.err_generic':             'A művelet nem sikerült.',
  'names.mode_warn':               'A szabályfájl jogosultsága nem 0600. Mivel magánszemély nevét tartalmazhatja, ezt érdemes helyreállítani.',
  'names.read_only':               'Ez a dashboard git worktree-ből fut, ezért innen nem szerkeszthetők a szabályok. Használd a fő telepítés dashboardját.',
