...
window._i18n.en = {
  ...
  'overview.quota.modeltier.hint':     'The chain order defines the steps: the first entry is the primary model, each next one is a tier cheaper. As the weekly % climbs, every role-agent steps down the chain; it reverts to the primary at the weekly reset. mikrob-channels is exempt.',
  'overview.quota.modeltier.chainTitle': 'Model chain (order = tiers)',
  'overview.quota.modeltier.addModel': '+ Add model',
  'overview.quota.modeltier.save':     'Save',
  'overview.quota.modeltier.saved':    'Saved.',
  'overview.quota.modeltier.primaryTag': 'primary',
  'overview.quota.modeltier.primaryPlaceholder': 'primary model id',
  'overview.quota.modeltier.stepPlaceholder': 'cheaper model id',
  'overview.quota.modeltier.modelAria': 'Model {n} in the chain',
  'overview.quota.modeltier.moveUp':   'Move up',
  'overview.quota.modeltier.moveDown': 'Move down',
  'overview.quota.modeltier.removeModel': 'Remove model',
  'overview.quota.modeltier.errMinChain': 'The chain must contain at least 2 models (primary + at least one cheaper fallback).',
