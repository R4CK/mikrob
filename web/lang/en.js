...
window._i18n.en = {
  ...
  'localLlm.usage.recent':       'Recent calls',
  ...
  'localLlm.trustConfirm.basis_owner':            'Publisher',
  'localLlm.trustConfirm.basis_downloads':        'Downloads',
  'localLlm.trustConfirm.basis_downloads_unknown': 'unknown',
  'localLlm.trustConfirm.basis_parts':            'Digests ({count} parts)',
  'localLlm.trustConfirm.digest_missing':         'no digest',
  'localLlm.trustConfirm.empty_error':            'You must type the publisher name (or the model tag) to confirm.',
  'localLlm.trustConfirm.wrong_answer_error':     'That does not match the publisher -- read the details above and type exactly what you are confirming.',
