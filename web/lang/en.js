...
window._i18n.en = {
  ...
  'kanban.modal.blockers_title': 'Blocked by',
  'kanban.modal.blocking_title': 'Waiting on this card',
  'kanban.blocker.add_placeholder': '-- Add a blocking card --',
  'kanban.blocker.add_placeholder_short': 'Add blocker',
  'kanban.blocker.none': 'Nothing is blocking this',
  'kanban.blocker.remove_btn': 'Remove blocker',
  'kanban.blocker.open_hint': 'Open card',
  'kanban.blocker.card_badge': '⛔ blocked',
  'kanban.blocker.card_tooltip': 'Blocked by {n} open card(s)',
  'kanban.toast.blocker_add_error': 'Error adding blocker',
  'kanban.toast.blocker_remove_error': 'Error removing blocker',
  'kanban.toast.blocker_not_on_board': 'That card is not on the board (archived or filtered out)',
  ...
  'ideas.scope.label':           'Area',
  'ideas.scope.munka':           'Work',
  'ideas.scope.szemelyes':       'Personal',
  'ideas.scope.all':             'All',
  'ideas.scope.current':         'Area: {scope}',
  'ideas.scope.move':            'Move to {scope}',
  'ideas.scope.move_error':      'Could not move the idea',
  'ideas.upload.button':         'Upload',
  'ideas.upload.uploading':      'Uploading: {name}',
  'ideas.upload.summary':        '{uploaded} uploaded, {failed} failed',
  'ideas.upload.error':          'Upload failed',
  ...
  'ideas.detail.attach.title':   'Attachments',
  'ideas.detail.attach.add':     'Add file',
  'ideas.detail.attach.empty':   'No attachments',
  'ideas.detail.attach.uploading': 'Uploading: {name}',
  'ideas.detail.attach.uploaded': 'File uploaded',
  'ideas.detail.attach.upload_error': 'Could not upload the file',
  'ideas.detail.attach.load_error': 'Could not load the attachments',
  'ideas.detail.attach.download': 'Download',
  'ideas.detail.attach.delete':  'Delete',
  'ideas.detail.attach.confirm_delete': 'Delete this attachment?',
  'ideas.detail.attach.delete_error': 'Could not delete the attachment',
  'ideas.detail.attach.has_text': 'The PDF text is readable',
  'ideas.detail.attach.text_marker': 'text',
  ...
  'agents.guard_phase_tip_handoff':    'The context-guard asked this agent for a handoff (its context filled up) and is waiting for HANDOFF.md to be written.',
  'agents.guard_phase_tip_restarting': 'The context-guard restarted this agent and is waiting for the fresh session to come up.',
  'agents.guard_phase_tip_cooldown':   'The context-guard intervened on this agent recently and will not act again until the shown time passes. The number is the time remaining.',
