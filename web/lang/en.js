...
window._i18n.en = {
  ...
  'overview.quota.strip_title':     'Subscription quota',
  ...
  'overview.quota.empty':           'No weekly % recorded. Enter the weekly value (All models) shown on the Claude usage screen.',
  'overview.quota.auto_empty':      'No data — the panel reader will update this automatically.',
  'overview.quota.row.weekly':      'Weekly (All)',
  ...
  'overview.quota.source.manual':   'manual',
  'overview.quota.pctLabel':        'Weekly % (0–100)',
  'overview.quota.resetLabel':      'Reset (optional)',
  'overview.quota.save':            'Save',
  'overview.quota.edit':            'Update %',
  'overview.quota.resets':          'Resets: {at}',
  'overview.quota.updated':         'Updated {rel}',
  'overview.quota.error':           'Unavailable',
  'overview.quota.saveError':       'Save failed.',
  'overview.quota.help_aria':       'Threshold rules',
  'overview.quota.help.title':      'Weekly threshold rules',
  'overview.quota.help.p1':         'There are two independent thresholds, regardless of how many days remain until the weekly reset.',
  'overview.quota.help.p2':         '"New dev stops" (default 90%): no new planned-card dispatch starts, in-flight work and gates still finish normally, mechanical coding work moves to local-LLM offload.',
  'overview.quota.help.p3':         '"Testing/review also stops" (default 97%, must be higher than the first): at this level QA/Cybersec/Cybered gate work stops too, every role-agent gets parked -- only MikroB stays running.',
  'overview.quota.help.p4':         'Both thresholds are editable at the bottom of this panel.',
  'overview.quota.threshold.toggle':'Edit thresholds',
  'overview.quota.threshold.gt3':   '> 3 days to reset',
  'overview.quota.threshold.lt2':   '< 2 days to reset',
  'overview.quota.threshold.lt1':   '< 1 day to reset',
  ...
  'overview.quota.modeltier.toggle':   'Model stepdown (weekly %)',
  'overview.quota.modeltier.enable':   'Weekly model stepdown enabled',
  'overview.quota.modeltier.tier1':    'Tier 1 (one step cheaper)',
  'overview.quota.modeltier.tier2':    'Tier 2 (a further step cheaper)',
  'overview.quota.modeltier.hint':     'Each agent steps one rung down the shared model ladder (capability-descending) FROM ITS OWN base model, one rung per tier. As the weekly % climbs it steps down; at the weekly reset it returns to its own base. The ladder shares one source with the model picker. mikrob-channels is exempt.',
  'overview.quota.modeltier.stateTitle': 'Agent state (read-only)',
  'overview.quota.modeltier.stateEmpty': 'No agents to display.',
  'overview.quota.modeltier.stateError': 'Failed to load agent state.',
  'overview.quota.modeltier.exemptTag': 'exempt',
  'overview.quota.modeltier.tierTag':  'Tier {n}',
  'overview.quota.modeltier.stateAria': 'Base: {base}, current: {current}, weekly-ramp target: {target}.',
  'overview.quota.modeltier.save':     'Save',
  'overview.quota.modeltier.saved':    'Saved.',
  'overview.quota.llm.title':       'Local LLM',
  'overview.quota.llm.helpAria':    'Token-savings calculation',
  'overview.quota.llm.helpTitle':   'Token-savings calculation',
  'overview.quota.llm.helpBody':    'The figure sums the local model\'s ACTUAL prompt and output token counts for every real, successful call -- not an estimate. Those tokens ran on the local GPU, outside the Claude quota, so they saved roughly that many Claude tokens an equivalent online call would have used.',
  'overview.quota.llm.model':       'Model',
  'overview.quota.llm.today':       'Today',
  'overview.quota.llm.week':        'This week',
  'overview.quota.llm.tokensSaved': 'Tokens saved',
  'overview.quota.llm.count':       '{n} tasks',
  'overview.quota.llm.pending':     'Coming soon',
  'overview.quota.llm.error':       'Could not load local-LLM stats.',
  ...
  'federation.tailscale.title':        'My connection info',
  'federation.tailscale.hint':         'Give this id and address to the other system\'s admin so they can add you as a peer.',
  'federation.tailscale.login_btn':    'Sign in with Tailscale',
  'federation.tailscale.retry_btn':    'Retry',
  'federation.tailscale.pending':      'Connecting...',
  'federation.tailscale.open_login_btn': 'Open the login link',
  'federation.tailscale.popup_blocked': 'The browser blocked the automatic pop-up -- open it manually with the button below.',
  'federation.tailscale.system_id_label': 'System id',
  'federation.tailscale.base_url_label':  'Address',
  'federation.tailscale.copy_btn':     'Copy',
  'federation.tailscale.copied':       'Copied to clipboard',
  'federation.tailscale.manual_hint':  'If Tailscale isn\'t installed on this machine, or the automatic step doesn\'t work, the manual steps in docs/mobil-dashboard.md are also available.',
  'federation.tailscale.error_generic': 'The Tailscale connection failed. Try again, or see the manual steps in docs/mobil-dashboard.md.',
  ...
  'kanban.diff.title':                'Diff & inline comments',
  'kanban.diff.collapse':             'Collapse',
  'kanban.diff.expand':               'Expand',
  'kanban.diff.empty':                'No diff comments for this card yet.',
  'kanban.diff.error':                'Could not load diff.',
  'kanban.diff.add_comment_ph':       'Inline comment...',
  'kanban.diff.add_btn':              'Send',
  'kanban.diff.cancel_btn':           'Cancel',
  'kanban.diff.delete_btn':           'Delete',
  ...
  'kanban.deps.no_successors':      'No card is waiting for this one.',
  'kanban.deps.search_placeholder': 'Search cards by title...',
  'kanban.deps.add_btn':            'Add dependency',
  'kanban.deps.remove_btn':         'Remove dependency',
  'kanban.deps.added':              'Dependency added',
  'kanban.deps.removed':            'Dependency removed',
  'kanban.deps.blocking':           '(blocking)',
  'kanban.deps.priority_saved':     'Blocking card priority saved',
  'kanban.deps.pick_from_list':     'Pick a card from the list (its id is shown next to the title).',
  'kanban.deps.blocked_toast':      'Cannot proceed: these have to be finished first -- {titles}',
  ...
  'memories.graph.rel.toggle':   'Kanban relations',
  'memories.graph.rel.card':     'Card',
  'memories.graph.rel.file':     'File',
  'memories.graph.rel.decision': 'Decision',
  'memories.graph.rel.other':    'Other',
  'memories.graph.rel.loading':  'Loading kanban relations...',
  'memories.graph.rel.empty':    'The loaded memories do not reference any kanban card that has relations. Change the agent filter, or search for a memory that contains a card id.',
  'memories.graph.rel.error':    'Kanban relations could not be loaded. Try again; if that does not help, check that the dashboard server is running.',
  'memories.graph.rel.offline':  'No network connection, kanban relations cannot be loaded. Reconnect, then try again.',
  'memories.graph.rel.retry':    'Retry',
  'memories.graph.rel.close':    'Close',
  'memories.graph.rel.open_card': 'Open on the kanban board',
  'memories.graph.rel.card_missing': 'This card no longer exists (deleted or archived).',
  'memories.graph.rel.card_load_error': 'The card details could not be loaded. Try again.',
  'memories.graph.rel.mentions': '{n} memories reference it',
  'memories.graph.rel.touched_by': 'Touched by {n} cards',
  'memories.graph.rel.connections': '{n} connections',
  ...
  'localLlm.page_title':         'Local LLM',
  'localLlm.page_subtitle':      'Control the local offload model (Ollama on the WSL GPU)',
  'localLlm.btn.refresh':        'Refresh',
  'localLlm.load_error':         'Could not load local LLM data.',
  'localLlm.offload.title':      'Offload aggressiveness',
  'localLlm.offload.desc':       'How much mechanical code to hand to the local GPU. Higher = more offload, fewer Claude tokens.',
  'localLlm.offload.off':        'Off (0)',
  'localLlm.offload.max':        'Max (100)',
  'localLlm.offload.optimal':    'Optimum',
  'localLlm.offload.saved':      'Saved: {value}',
  'localLlm.offload.save_error': 'Save failed, please retry.',
  ...
  'localLlm.offload.ramp.reason.manual': 'Manual override active — the auto ramp is not driving aggressiveness.',
  'localLlm.offload.ramp.reason.atThreshold': 'Weekly quota has reached the threshold — aggressiveness pinned at 100.',
  'localLlm.offload.ramp.reason.ramping': 'The auto ramp is raising aggressiveness toward the threshold as the weekly quota climbs.',
  'localLlm.offload.ramp.reason.floor': 'Automatic mode at the baseline aggressiveness — the weekly quota is not raising it yet.',
  'localLlm.offload.difficulty.label': 'Coding-difficulty threshold',
  'localLlm.offload.difficulty.desc': 'The hardest coding task that may still be drafted locally. Higher threshold = harder tasks run on the local model too.',
  'localLlm.offload.difficulty.auto': 'Automatic (follow the slider)',
  'localLlm.offload.difficulty.trivial': 'Trivial — snippet / regex / formatting',
  'localLlm.offload.difficulty.isolated': 'Isolated — function / test / type',
  'localLlm.offload.difficulty.module': 'Module — multi-function (single file)',
  'localLlm.offload.difficulty.feature': 'Feature — multi-file',
  'localLlm.offload.difficulty.architecture': 'Architecture / wiring',
  'localLlm.offload.difficulty.level.trivial': 'trivial',
  'localLlm.offload.difficulty.level.isolated': 'isolated',
  'localLlm.offload.difficulty.level.module': 'module',
  ...
  'localLlm.categories.title':   'Categories',
  'localLlm.categories.desc':    'Every local-offload task category, live from the router — not just coding difficulty. Disabling a category here means that task type now runs online (Claude).',
  ...
  'localLlm.categories.disabled_msg': 'Category disabled: {task} — this task type now runs online.',
  'localLlm.categories.save_error': 'Could not save the category, try again.',
  'localLlm.routing.title': 'Task routing',
  'localLlm.routing.desc': 'Which task type goes to which model, and why. The switch is real: a disabled preset runs online (Claude) from then on.',
  'localLlm.routing.summary': 'Default model: {model} · difficulty threshold: {threshold} · aggressiveness: {aggr}',
  'localLlm.routing.endpoint_missing': 'The routing-decisions endpoint is not available yet (BE card ecf38e5a). The preset switches work; the model column and the two panels fill in once it lands.',
  'localLlm.routing.endpoint_missing_short': 'Routing data not available yet.',
  'localLlm.routing.endpoint_error': 'Could not load the routing data. Refresh the page; if it persists, check the server log.',
  'localLlm.routing.route_default': 'default',
  'localLlm.routing.route_override': 'override',
  'localLlm.routing.route_default_tip': 'This preset goes to the default model in store/local-llm-model.',
  'localLlm.routing.route_override_tip': 'local-llm-model-routing.json assigns a specific model to this preset.',
  'localLlm.routing.route_unknown': 'model: unknown',
  'localLlm.routing.route_online_now': 'disabled → online',
  'localLlm.routing.always_online_title': 'Always online',
  'localLlm.routing.always_online_desc': 'The router never hands these categories to the local model, whatever the slider says.',
  'localLlm.routing.always_online_empty': 'No always-online category in the router.',
  'localLlm.routing.ceiling_never': 'never local',
  'localLlm.routing.ceiling_upto': 'local up to: {level}',
  'localLlm.routing.decisions_title': 'Latest card decisions',
  'localLlm.routing.decisions_desc': 'card-build-route verdicts at dispatch time: local draft or online, and the reason.',
  'localLlm.routing.decisions_empty': 'No card decision in the log yet.',
  'localLlm.routing.decisions_unavailable': 'The decision log (card-build-route.log) cannot be read.',
  'localLlm.routing.verdict_local': 'LOCAL',
  'localLlm.routing.verdict_online': 'ONLINE',
  'localLlm.routing.verdict_decomposed': 'PARTIALLY LOCAL',
  'localLlm.routing.decision_calls': '{n} model calls',
  'localLlm.routing.decisions_window': 'last {hrs} hrs',
  'localLlm.routing.summary_decomposed': 'PARTIALLY LOCAL: {n}',
  'localLlm.routing.decision_decompose': '{n} subtask candidate(s): {types}',
  'localLlm.routing.reason.priority_high': 'High priority',
  'localLlm.routing.reason.priority_urgent': 'Urgent',
  'localLlm.routing.reason.deterministic_multi_decision': 'Multiple decision points',
  'localLlm.routing.reason.deterministic_object_integrity': 'Object integrity',
  'localLlm.routing.reason.all_stages_passed': 'All stages local',
  'localLlm.routing.reason.steering_attempt': 'Steering attempt',
  'localLlm.models.summary': '{installed} installed models · {disabled} disabled',
  'localLlm.models.summary_offline': '{installed} known models (Ollama is not running) · {disabled} disabled',
  'localLlm.models.route_default': 'default: every other preset',
  'localLlm.models.route_presets': '{n} presets routed here',
  'overview.llmDist.lane_disabled': 'Disabled',
  'overview.llmDist.lane_open': 'Open on the Local LLM page',
  'overview.llmDist.tooltip.routing': 'Routing',
  'overview.llmDist.tooltip.routing_override': 'override → {model}',
  'overview.llmDist.tooltip.routing_default': 'default model ({model})',
  'localLlm.status.title':       'Status',
  'localLlm.status.ollama':      'Ollama',
  'localLlm.status.up':          'Up',
  ...
  'localLlm.status.embed_model_role': 'Memory search, vectorisation (RAG)',
  'localLlm.status.in_vram':         'Loaded in VRAM',
  'localLlm.status.not_in_vram':     'Not in VRAM',
  'localLlm.status.bridge':      'Ghost quota-bridge',
  'localLlm.status.running':     'Running',
  'localLlm.status.stopped':     'Stopped',
  'localLlm.status.gpu':         'GPU',
  'localLlm.status.no_gpu':      'No GPU data',
  'localLlm.models.title':       'Models',
  'localLlm.models.empty':       'No models pulled.',
  'localLlm.models.active':      'Active',
  'localLlm.models.use':         'Activate',
  'localLlm.models.update':      'Update',
  'localLlm.models.pull_placeholder': 'e.g. qwen2.5-coder:7b',
  'localLlm.models.pull_btn':    'Pull',
  'localLlm.models.pull_empty':  'Enter a model name.',
  'localLlm.models.pull_starting': 'Starting pull...',
  'localLlm.models.pulling':     'Pulling',
  'localLlm.models.pull_done':   'Pulled: {model}',
  'localLlm.models.pull_failed': 'Pull failed.',
  'localLlm.models.swapped':     'Active model: {model}',
  'localLlm.models.disabled_badge': 'Disabled',
  'localLlm.models.toggle.enable': 'Enable',
  'localLlm.models.toggle.disable': 'Disable',
  'localLlm.models.toggle.enable_tip': 'Make this model available to local routing again.',
  'localLlm.models.toggle.disable_tip': 'Routing and the queue will not pick this model while it is disabled.',
  'localLlm.models.toggle.saved_on': '{model} enabled',
  'localLlm.models.toggle.saved_off': '{model} disabled -- local routing will not use it',
  ...
  'localLlm.models.bench.unmeasured_hint': 'Not measured. Run: store/local-llm-bench.sh',
  'localLlm.test.title':         'Quick test',
  'localLlm.test.hint':          'Try the local model through the RAG wrapper (with mikrob memory).',
  'localLlm.test.placeholder':   'Type a prompt...',
  'localLlm.test.run_btn':       'Run',
  'localLlm.test.empty':         'Prompt is empty.',
  'localLlm.test.running':       'The local model is working...',
  'localLlm.test.no_output':     '(no output)',
  'localLlm.logs.title':         'Terminal and running tasks',
  'localLlm.logs.bridge':        'Quota-bridge',
  'localLlm.logs.ollama':        'Ollama',
  'localLlm.logs.empty':         '(no log entries)',
  'localLlm.running.none':       'No running generation right now.',
  'localLlm.running.vram':       'VRAM',
  'localLlm.usage.title':        'Usage',
  'localLlm.usage.total':        'Total calls',
  'localLlm.usage.today':        'Today',
  'localLlm.usage.last_7d':      'Last 7 days',
  'localLlm.usage.by_agent':     'By agent',
  'localLlm.usage.by_source':    'By source and task',
  'localLlm.usage.by_day':       'Last 14 days',
  'localLlm.usage.recent':       'Activity (today)',
  'localLlm.usage.none':         'No calls recorded yet.',
  'localLlm.usage.source_bare':  'Direct (bare)',
  'localLlm.usage.source_rag':   'RAG wrapper',
  'localLlm.usage.code_calls':   'Coding calls',
  'localLlm.usage.ui_probes':    'UI probe (excluded)',
  'localLlm.usage.status_ok':    'OK',
  'localLlm.usage.status_err':   'Error',
  'localLlm.usage.col_time':     'Time',
  'localLlm.usage.col_agent':    'Agent',
  'localLlm.usage.col_task':     'Task',
  'localLlm.usage.col_source':   'Source',
  'localLlm.usage.col_ms':       'ms',
  'localLlm.usage.col_status':   'Status',
  'localLlm.rec.title':          'Recommended models',
  'localLlm.rec.hint':           'The best coding models for this GPU (GTX 1660 Ti, 6 GB VRAM). Models above ~5 GB spill to CPU and run slower.',
  'localLlm.rec.gpu_hint':       'Catalogue filtered and validated for your GPU -- {name} ({vram} VRAM).',
  'localLlm.rec.gpu_unknown':    'unknown GPU',
  'localLlm.rec.cpu_only_hint':  'No GPU detected -- showing only smaller, CPU-runnable models.',
  'localLlm.rec.stale_banner':   'The catalogue did not refresh live just now (network or rate limit) -- showing the last successfully fetched data.',
  'localLlm.rec.load_error':     'Could not load the model catalogue.',
  'localLlm.rec.empty':          'No model in the catalogue fits this GPU.',
  'localLlm.rec.pull_btn':       'Download',
  'localLlm.rec.use_btn':        'Activate',
  'localLlm.rec.activate_error': 'Activation failed -- the model may not be downloaded, or Ollama is unreachable.',
  'localLlm.rec.fit_fits':       'Fits',
  'localLlm.rec.fit_tight':      'Tight (partly on CPU)',
  'localLlm.rec.trust.trusted':          'Verified publisher',
  'localLlm.rec.trust.trusted_tip':      'The publisher is on the trust allowlist (a separate list from relevance filtering).',
  'localLlm.rec.trust.unverified':       'Unverified',
  'localLlm.rec.trust.unverified_tip':   'The publisher is not on the trust allowlist -- install with care.',
  'localLlm.rec.downloads_tip':  'Download count on HuggingFace',
  'localLlm.rec.digest_tip':     'Start of the first file part\'s SHA-256 digest',
  'localLlm.rec.recommended':        'Recommended',
  'localLlm.rec.recommended_tip':    'The default pick, chosen by best fit, verified publisher, and download count.',
  'localLlm.rec.variant_select_aria': 'Quantisation variant -- {name}',
  ...
  'localLlm.hf.title':           'HuggingFace search',
  'localLlm.hf.hint':            'Search GGUF coding models on HuggingFace; GGUF results can be pulled straight into Ollama.',
  'localLlm.hf.query_placeholder': 'Search (e.g. qwen coder, deepseek)',
  'localLlm.hf.task_label':      'Task',
  'localLlm.hf.task_codegen':    'Text generation (code)',
  'localLlm.hf.task_any':        'Any',
  'localLlm.hf.sort_label':      'Sort',
  'localLlm.hf.sort_downloads':  'Downloads',
  'localLlm.hf.sort_likes':      'Likes',
  'localLlm.hf.sort_trending':   'Trending',
  'localLlm.hf.sort_recent':     'Recently updated',
  'localLlm.hf.gguf_only':       'GGUF only (Ollama-pullable)',
  'localLlm.hf.search_btn':      'Start search',
  'localLlm.hf.searching':       'Searching HuggingFace...',
  'localLlm.hf.empty':           'No results. Adjust the filters and try again.',
  'localLlm.hf.error':           'HuggingFace search failed. Check the network and try again.',
  'localLlm.hf.initial':         'Start a search with the filters above.',
  'localLlm.hf.result_count':    '{count} results',
  'localLlm.hf.dl':              'downloads',
  'localLlm.hf.likes':           'likes',
  'localLlm.hf.gguf_badge':      'GGUF',
  'localLlm.hf.not_gguf':        'not GGUF – Ollama can’t pull it',
  'localLlm.hf.pull_btn':        'Pull',
  ...
  'localLlm.queue.tile.failed':  'Failed',
  'localLlm.queue.tile.latency': 'Avg time',
  'localLlm.queue.recent':       'Recent items',
  'localLlm.queue.filter.all':      'All',
  'localLlm.queue.filter.pending':  'Pending',
  'localLlm.queue.filter.running':  'Running',
  'localLlm.queue.filter.done':     'Done',
  'localLlm.queue.filter.failed':   'Failed',
  'localLlm.queue.filter.aria':     'Filter by status',
  'localLlm.queue.col_time':     'Created',
  'localLlm.queue.col_agent':    'Agent',
  'localLlm.queue.col_task':     'Task',
  'localLlm.queue.col_priority': 'Priority',
  'localLlm.queue.col_status':   'Status',
  'localLlm.queue.col_source':   'Source',
  'localLlm.queue.col_ms':       'ms',
  'localLlm.queue.col_state':    'State',
  'localLlm.queue.col_action':   'Result',
  'localLlm.queue.view_btn':     'View',
  'localLlm.queue.none':         'The work queue is empty.',
  'localLlm.queue.load_error':   'Could not load the work queue. Try again.',
  'localLlm.queue.status.pending': 'Pending',
  'localLlm.queue.status.running': 'Running',
  'localLlm.queue.status.done':    'Done',
  'localLlm.queue.status.failed':  'Failed',
  'localLlm.queue.detail.title':     'Work queue item',
  'localLlm.queue.detail.agent':     'Agent',
  'localLlm.queue.detail.task':      'Task type',
  'localLlm.queue.detail.template':  'Template',
  'localLlm.queue.detail.priority':  'Priority',
  'localLlm.queue.detail.status':    'Status',
  'localLlm.queue.detail.attempts':  'Attempts',
  'localLlm.queue.detail.card':      'Card',
  'localLlm.queue.detail.created':   'Created',
  'localLlm.queue.detail.started':   'Started',
  'localLlm.queue.detail.finished':  'Finished',
  'localLlm.queue.detail.result':    'Result',
  'localLlm.queue.detail.error':     'Error',
  'localLlm.queue.detail.no_result': 'No result yet.',
  'localLlm.queue.detail.load_error': 'Could not load the item. Try again.',
  ...
  'settings.module.integrations': 'Integrations',
  'settings.module.security':    'Security',

  // Integrations tab — Gemini API key
  'integrations.gemini.title':          'Gemini API',
  'integrations.gemini.desc':           'Google Gemini API key — required for model calls.',
  'integrations.gemini.status.set':     'Key configured',
  'integrations.gemini.status.unset':   'No key set',
  'integrations.gemini.input.label':    'API key',
  'integrations.gemini.input.ph':       'AIza...',
  'integrations.gemini.btn.save':       'Save',
  'integrations.gemini.btn.saving':     'Saving...',
  'integrations.gemini.btn.delete':     'Remove',
  'integrations.gemini.btn.deleting':   'Removing...',
  'integrations.gemini.btn.show':       'Show',
  'integrations.gemini.btn.hide':       'Hide',
  'integrations.gemini.saved':          'API key saved successfully.',
  'integrations.gemini.deleted':        'API key removed.',
  'integrations.gemini.err.empty':      'API key cannot be empty.',
  'integrations.gemini.err.save':       'Failed to save. Please try again.',
  ...
  'agents.hud.context_label':      'Context',
  'agents.hud.context_disabled':   'Context measurement off',
  'agents.hud.active_model':       'Active: {model}',
  ...
  'conversation.session_newest': 'Latest session',
  'conversation.session_entries':'{count} entries',
  'conversation.sessions_error': 'Session list unavailable',
  ...
  'updates.integrated.title':    'Adopted repos freshness',
  'updates.integrated.counts':   '{total} adopted repos: {fresh} up to date, {behind} behind ({review} need review first), {unknown} not measurable.',
  'updates.integrated.last_checked': 'Last checked: {date}',
  'updates.integrated.never_checked': 'No repo has been checked yet.',
  'updates.integrated.never_count': '{n} repos never checked',
  'updates.integrated.behind_item': '{n} commits behind',
  'updates.integrated.empty':    'The registry is empty: no watched or adopted repo.',
  'updates.integrated.col.name': 'Repo',
  'updates.integrated.col.kind': 'Kind · adoption',
  'updates.integrated.col.enabled': 'Enabled',
  'updates.integrated.col.installed': 'Installed',
  'updates.integrated.col.last_checked': 'Last checked',
  'updates.integrated.col.state': 'Freshness',
  'updates.integrated.col.note': 'Review note',
  'updates.integrated.note_summary': 'Note ({n} characters)',
  'updates.integrated.link':     'Card view, with update actions',
  'updates.integrated.error':    'The adopted repos\' freshness could not be read right now. Retry with the Check button, or open the Adopted repos page.',
  ...
  'repos.stat.total':            'Built-in repo',
  'repos.detect_info_box':       'For adopted repos freshness is measured data: the last-checked date and the upstream lag in commits (up to date / N commits behind / not measurable). Repos added from the dashboard have no such measurement; their Update button always runs a git pull.',
  'repos.stat.fresh':            'Up to date',
  'repos.stat.behind':           'Behind',
  'repos.stat.review':           'Review first',
  'repos.stat.unknown':          'Not measurable',
  'repos.fresh.up_to_date':      'up to date',
  'repos.fresh.up_to_date_title': 'The local copy is at the tip of the upstream branch (as of the last check).',
  'repos.fresh.unknown':         'not measurable',
  'repos.fresh.unknown_title':   'No local upstream reference (pipx install, or a clone not synced yet): the lag cannot be determined from here.',
  'repos.last_checked_never':    'not yet',
  'repos.add_placeholder':       'https://github.com/user/repo',
  'repos.add_btn':               'Add',
  'repos.loading':               'Loading...',
  'repos.load_error':            'Failed to load repos',
  'repos.empty_msg':             'No built-in repos yet',
  'repos.empty_hint':            'Add one with the field above',
  'repos.detect_pending_title':  'Update detection is not available yet (backend work in progress)',
  'repos.badge.pending_check':   'Check coming soon',
  'repos.badge.adopted':         'adopted',
  'repos.tooltip.how':           'Integration',
  'repos.tooltip.aria':          'Repo information',
  'repos.integ.vendored':        'vendored clone (outside repo, daily sync)',
  'repos.integ.folded':          'folded into CLAUDE.md as principles',
  'repos.integ.manual':          'added from the dashboard (git clone)',
  'repos.update_available_badge': 'update',
  'repos.update_available_msg':  'Update available: {n} new commit(s) upstream.',
  'repos.update_review_required': 'Review required before updating (executable code).',
  'repos.installed':             'installed',
  'repos.installed_title':       'Installed and in use (adopted external development)',
  ...
  'kanban.filter.priority_label':   'Dispatch priority:',
  'kanban.filter.priority_default': 'Default order',
  'kanban.filter.priority_tooltip': 'The chosen projects\' cards go first at every dispatch decision, in the listed order, until cleared back to Default order.',
  'kanban.filter.priority_saved':   'Dispatch priority set: {project}',
  'kanban.filter.priority_cleared': 'Dispatch priority cleared -- default order restored',
  'kanban.filter.priority_save_failed': 'Could not save the dispatch priority -- please try again.',
  'kanban.filter.priority_add':     '+ Add project',
  'kanban.filter.priority_remove':  'Remove {project} from priority',
  ...
  'llmMon.page_subtitle':       'Task timeline per agent, workload and model usage in the selected window',
  'llmMon.window.label':        'Window',
  'llmMon.window.1h':           'Past 1 hour',
  'llmMon.window.6h':           'Past 6 hours',
  'llmMon.window.24h':          'Past 24 hours',
  'llmMon.window.7d':           'Past 7 days',
  'llmMon.meta':                '{window}: {from} – {to}',
  'llmMon.kpi.active_models':   'Active models',
  'llmMon.kpi.tasks':           'Tasks',
  'llmMon.kpi.failed_sub':      '{n} failed',
  'llmMon.kpi.avg_duration':    'Avg task duration',
  'llmMon.kpi.total_requests':  'Total requests',
  'llmMon.kpi.error_rate':      'Error rate',
  'llmMon.coverage_note':       'Only these lanes can draw timeline blocks: {lanes}. Online-model work is counted, but no per-task duration is stored for it.',
  'llmMon.truncated_note':      'Only the first {n} tasks are shown in this window -- narrow the window for the full picture.',
  'llmMon.empty':               'No finished task in this window ({window}).',
  'llmMon.error':               'Could not load the task data. Retry, or pick another window.',
  'llmMon.retry':               'Retry',
  'llmMon.swimlane.title':      'Task timeline (per agent)',
  'llmMon.swimlane.scroll_hint':'The lane opens at now. Drag the scrollbar left to go back in time; click a block for details.',
  'llmMon.swimlane.legend_title':'Category',
  'llmMon.series.title':        'Workload time-series',
  'llmMon.series.y_label':      'Tasks started / {bucket}',
  'llmMon.series.other':        'other',
  'llmMon.modelSeries.title':   'Requests-per-model time-series',
  'llmMon.modelSeries.y_label': 'Requests / {bucket}',
  'llmMon.modelSeries.empty':   'No online-model traffic in this window.',
  'llmMon.models.title':        'Models in the selected window',
  'llmMon.models.empty':        'No model usage in this window.',
  'llmMon.models.col.model':    'Model',
  'llmMon.models.col.requests': 'Requests',
  'llmMon.models.col.tokens':   'Tokens (in / out)',
  'llmMon.models.col.agents':   'Agents',
  'llmMon.detail.title':        'Task details',
  'llmMon.detail.category':     'Category',
  'llmMon.detail.agent':        'Agent',
  'llmMon.detail.status':       'Status',
  'llmMon.detail.duration':     'Duration',
  'llmMon.detail.started':      'Started',
  'llmMon.detail.card':         'Card',
  'llmMon.detail.no_card':      'not tied to a card',
  'llmMon.detail.tokens_note':  'No token or throughput data is recorded for this task: the task log stores durations only; tokens are measured separately by the model-usage ledger.',
  'llmMon.detail.close':        'Close',
  'llmMon.status.done':         'done',
  'llmMon.status.failed':       'failed',
  'llmMon.dur.ms':              '{n} ms',
  'llmMon.dur.sec':             '{n} s',
  'llmMon.dur.min':             '{m}:{s} min',
  'llmMon.bucket.min':          '{n} min',
  'llmMon.bucket.hour':         '{n} h',
  'overview.llmDist.title':             'Local LLM task distribution',
  'overview.llmDist.meta':              'last {hours}',
  ...
  'overview.llmDist.kpi.tokens_per_sec':'Tokens/Sec',
  'overview.llmDist.kpi.total_requests':'Total Requests',
  'overview.llmDist.kpi.error_rate':    'Error Rate',
  'overview.llmDist.legend_title':      'Task type',
  'overview.llmDist.tooltip.agent':     'Agent',
  'overview.llmDist.tooltip.duration':  'Duration',
  'overview.llmDist.tooltip.tokens':    'Tokens',
  'overview.llmDist.tooltip.tokens_value': '{total} ({in} in / {out} out)',
  'overview.llmDist.tooltip.throughput':'Throughput',
  'overview.llmDist.tooltip.status':    'Status',
  'overview.llmDist.status.ok':         'Success',
  'overview.llmDist.status.err':        'Error',
  'overview.llmDist.status.busy':       'Busy',
  'overview.llmDist.ms':                '{n} ms',
  'overview.llmDist.sec':               '{n}s',
  'overview.llmDist.tps':               '{n} t/s',
  ...
  'names.title':                   'Outgoing filter: names and phrases',
  'names.desc':                    'The outgoing-copy gate strips these names/phrases from Telegram and email messages. The list lives only on this machine and never reaches the repository.',
  'names.state.active':            'Active: {n} rule(s) loaded.',
  'names.state.empty':             'The list is empty, so the name check currently filters nothing.',
  'names.state.broken':            'The rules file is missing or malformed, so the name check is NOT running. This needs fixing.',
  'names.mode.literal':            'Exact text',
  'names.mode.regex':              'Regex (advanced)',
  'names.mode_hint':               '"Exact text" matches the name literally. "Regex" expects a Python pattern, and we run the same check the gate itself performs before saving.',
  'names.placeholder':             'Name or phrase',
  'names.add':                     'Add',
  'names.remove':                  'Remove',
  'names.confirm_remove':          'Remove this rule? Outgoing text will no longer be filtered for it.',
  'names.empty_list':              'No rules yet.',
  'names.added':                   'Added. {n} rule(s) now in effect.',
  'names.removed':                 'Removed. {n} rule(s) now in effect.',
  'names.err_empty':               'Enter the name or phrase to filter.',
  'names.err_generic':             'The operation failed.',
  'names.mode_warn':               'The rules file is not mode 0600. Since it may name a private individual, that is worth restoring.',
  'names.read_only':               'This dashboard runs from a git worktree, so rules cannot be edited here. Use the main installation dashboard.',
