...
window._i18n.en = {
  ...
  'localLlm.rec.load_error':     'Could not load recommended models.',
  'localLlm.rec.pull_btn':       'Pull / activate',
  'localLlm.rec.fit_fits':       'Fits',
  'localLlm.rec.fit_tight':      'Tight',
  'localLlm.rec.fit_spills':     'Spills to CPU',
  'localLlm.rec.note.small':     'Small model, fits easily in VRAM; fast but lower quality.',
  'localLlm.rec.note.balanced':  'Good balance of size and coding quality, fits comfortably.',
  'localLlm.rec.note.tight':     'Fits, but near the 6 GB VRAM ceiling; may slow down with long context.',
  'localLlm.rec.note.spills':    'Too large for 6 GB: spills to CPU, significantly slower.',
  ...
  'agents.hud.subagent_running':   'Running: {agent}',
