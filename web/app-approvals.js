// Approvals module -- extracted from app.js (card fa28ae18 / slice 6/N).
// Loaded AFTER app.js in index.html; globals (t, escapeHtml, escapeAttr, showToast)
// are resolved at call time, not parse time.
// Top-level event listener bindings are parse-time, but scripts execute after
// the full HTML body is parsed, so all getElementById calls succeed.
