// web/app-token-usage.js -- Token Usage Monitor page module
// Extracted from app.js (card 8d7550a8, slice 4/N).
// Load AFTER app.js in index.html: loadTokenUsage() is only called from switchPage,
// never at init time, so the loading order here is flexible -- but AFTER is safest.
// Globals used at call time (defined in app.js): t, escapeHtml
// Both are called only inside function bodies, after all scripts have loaded.
