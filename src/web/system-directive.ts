...
// FORK DELTA (card ab4c85f2), the ONLY intended difference from upstream in
// this file: the reserved id lives in a const-only module so the POST route's
// reserved-sender guard can share it without pulling this tmux-side module
// into the request path's import graph. Upstream declares it inline here and
// has no such guard. Keep the rest of this file upstream-identical.
import { SYSTEM_DIRECTIVE_SENDER } from './system-directive-id.js'

export { SYSTEM_DIRECTIVE_SENDER }
