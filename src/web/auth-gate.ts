...
export function requiresAuth(path: string, method: string): boolean {
  ...
  // Fork (card 5a57ba16 / F2): public fleet-health digest -- intentionally UNAUTH,
  // exposes ONLY aggregate counts + version (never names/paths/tokens/PII -- see
  // routes/public-digest.ts for the trust-boundary contract).
