...
// MEMIRASNYOM915 (ported from upstream ab7c6d5f): a lost concurrent write on
// `memories` used to be undetectable after the fact -- no updated_at, no
// writer trace. These tests pin the write-trace contract:
