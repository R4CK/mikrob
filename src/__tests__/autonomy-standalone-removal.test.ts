...
const APP_DEVICE_KEYS = readFileSync(join(__dirname, '../../web/app-device-keys.js'), 'utf-8')
const APP_AUTONOMY    = readFileSync(join(__dirname, '../../web/app-autonomy.js'),    'utf-8')
const APP  = APP_CORE + '\n' + APP_DEVICE_KEYS + '\n' + APP_AUTONOMY
