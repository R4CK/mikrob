...
// Fork-owned slice, not app.js: ideas was extracted to web/app-ideas.js (card cb5cef0f /
// slice 5/N) before this test's source existed upstream -- see the STUB comment in app.js.
const appJs = readFileSync(join(__dirname, '../../web/app-ideas.js'), 'utf8')
