...
// EMBSTALE916 (ported from upstream c9a778ad): an edit that changes the
// embedded text must drop the stored vector, because the vector still
// describes the PREVIOUS text and nothing in the schema records that. The
// next backfillEmbeddings() round regenerates it.
//
