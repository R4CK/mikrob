...
- **CleanCore** is a multi-tenant SaaS; per-tenant observability must respect tenant isolation (don't leak one tenant's metrics/logs to another) and cap per-tenant label cardinality.
